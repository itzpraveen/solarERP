...
equipmentSchema.virtual('availableStock').get(function() {
  return (this.inventory.inStock - this.inventory.allocated) + this.inventory.onOrder;
});

// Check if reordering is needed
equipmentSchema.virtual('needsReorder').get(function() {
  return (this.inventory.inStock - this.inventory.allocated) <= this.inventory.minimumStock;
});

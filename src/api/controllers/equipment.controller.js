...
exports.updateInventory = catchAsync(async (req, res, next) => {
  ...
  if (req.body.inStock !== undefined)
    equipment.inventory.inStock = req.body.inStock;
  if (req.body.allocated !== undefined)
    equipment.inventory.allocated = req.body.allocated;
  if (req.body.onOrder !== undefined)
    equipment.inventory.onOrder = req.body.onOrder;
  if (req.body.minimumStock !== undefined)
    equipment.inventory.minimumStock = req.body.minimumStock;
  if (req.body.location !== undefined)
    equipment.inventory.location = req.body.location;
...
exports.updateSupplier = catchAsync(async (req, res, next) => {
  ...
  if (!equipment) {
    return next(
      new AppError('No equipment or supplier found with that ID', 404)
    );
  }
...
exports.addCompatibleProduct = catchAsync(async (req, res, next) => {
  ...
  await Equipment.findByIdAndUpdate(compatibleProductId, {

                ...
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                      ...
                      {editMode ? (
                        ...
                        <Typography variant="h6" sx={{ mt: 0.5 }}>
                          ${project.financials.totalContractValue.toLocaleString()}
                        </Typography>
                      )}
                    </Grid>
                    ...
                    <Grid item xs={12} sm={6}>
                      ...
                      <Typography variant="h6" sx={{ mt: 0.5 }}>
                        ${(project.financials.totalExpenses || 0).toLocaleString()}
                      </Typography>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={6}>
                      ...
                      <Typography variant="h6" sx={{ mt: 0.5, color: (project.financials.projectedProfit || 0) > 0 ? 'success.main' : 'error.main' }}>
                        ${(project.financials.projectedProfit || 0).toLocaleString()}
                      </Typography>
                    </Grid>

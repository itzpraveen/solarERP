...
const { validateServiceRequest } = require('../validators/serviceRequestValidator');
...
exports.getServiceRequests = async (req, res) => {
  try {
    ...
    if (assignedTechnician) {
      filter.assignedTechnician = assignedTechnician === 'unassigned' 
        ? { $exists: false } 
...
exports.completeService = async (req, res) => {
  try {
    ...
    await serviceRequest.completeService(completionDate ? new Date(completionDate) : null, notes);

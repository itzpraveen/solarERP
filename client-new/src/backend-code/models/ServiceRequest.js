...
serviceRequestSchema.pre('save', function(next) {
  ...
  if (this.isModified('assignedTechnician') && this.assignedTechnician && this.status === 'new') {
...
serviceRequestSchema.methods.completeService = function(completionDate, notes) {
